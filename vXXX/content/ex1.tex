...
Because we don't know, at what m we start, we can compare two peaks lying next to each other. 
\begin{align*}
  \dfrac{2 n_2(\lambda_1) d}{\lambda_1} + \dfrac{1}{2} - \dfrac{2 n_2(\lambda_2) d}{\lambda_2} + \dfrac{1}{2} &= m - (m-1) = 1 \\
  \Leftrightarrow d &= \dfrac{\lambda_1 \lambda_2}{2 (n_2(\lambda_1) \lambda_2 - (n_2(\lambda_1) - \lambda_2))}
\end{align*}
This gives us
\begin{equation*}
  d = 200.43 \si{\nano\meter}.
