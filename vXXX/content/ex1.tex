...
done by using a reflection chamber, in which all light is absorbed or reflected and measured.
This data is shown in the first plot of \ref{fig:reflection}. It can be seen, that least light is adsorbed in the non-treated 
material. For high wavelengths ($\lambda > 1000 \si{\nano\meter}$), the cristalline silicon with an pyramidal surface structure shows 
the highest absorption. The black silicon shows much less absorption then expected, probably due to previous treatment during Fopras
which damaged the nano-surface structure.
\begin{figure}[h]
  \centering
...
a gradual transition from air (n ≈ 1) to silicon (n ≈ 3.5) due to the angled facets and partial filling of space. 
